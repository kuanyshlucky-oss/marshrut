...
func seedTrack() error {
	...
	// Шаблон дорожной карты 2026 — зимний период КТ.
	// Шаги 1-2 (регистрация до 10.11, тестирование до 11.12) — подтверждённые даты
	// с testcenter.kz. Шаги 3-8 официальных дат не публикуют (та же оговорка была и
	// для летних дат до этой правки) — оценены по тем же интервалам между шагами,
	...
	_, err := db.Exec(`INSERT INTO checklist_templates(year, step_order, description, deadline) VALUES
		(2026, 1, 'Зарегистрироваться на Комплексное тестирование (КТ) на сайте Национального центра тестирования', '2026-11-10'),
		(2026, 2, 'Сдать КТ (иностранный язык + профильный предмет)', '2026-12-11'),
