...
func seedTrack() error {
	...
	_, err := db.Exec(`INSERT INTO checklist_templates(year, step_order, description, description_kk, deadline) VALUES
		...
		(2026, 4, 'Подать заявление и документы в приёмную комиссию вуза (онлайн или очно)', 'ЖОО қабылдау комиссиясына өтініш пен құжаттарды тапсыру (онлайн немесе өзі келіп)', '2026-12-21'),
