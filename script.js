...
const COMMON_SUBJECTS = [
  {
    ...
    topics: [
      'Listening — 16 вопросов: аудирование коротких диалогов и объявлений',
      'Reading — 16 вопросов: чтение и понимание академических текстов',
      'Тесты — 18 вопросов: грамматика и лексика',
    ],
  },
  {
    ...
    sections: [
      {
        ...
        topics: [
          ...
          { title: 'Тема 2. Ориентирование линий местности', page: 2 },
          { title: 'Тема 3. Прямая и обратная геодезические задачи', page: 3 },
          { title: 'Тема 4. Топографические карты и планы. Масштабы. Уклон. Рельеф', page: 4 },
          { title: 'Тема 5. Геодезические измерения и их точность. Теория ошибок', page: 5 },
          { title: 'Тема 6. Угловые измерения', page: 6 },
          { title: 'Тема 7. Линейные измерения', page: 7 },
          { title: 'Тема 8. Измерение превышений', page: 8 },
          { title: 'Тема 9. Геодезические сети. Плановые и высотные сети сгущения', page: 9 },
          { title: 'Тема 10. Виды съёмок. Топографические съёмки', page: 10 },
          { title: 'Тема 11. Начальные сведения из инженерной геодезии', page: 11 },
          { title: 'Тема 12. Современные геодезические приборы', page: 12 },
        ],
      },
      {
        key: 'kartografiya',
        ...
        topics: [
          ...
          { title: 'Тема 2. Формы Земли, их параметры. Математическая основа карт', page: 2 },
          { title: 'Тема 3. Картографические проекции. Искажения на картах. Номенклатура', page: 3 },
          { title: 'Тема 4. Основные этапы создания карт', page: 4 },
          { title: 'Тема 5. Картографическая генерализация — типы и особенности', page: 5 },
          { title: 'Тема 6. Картографические способы изображения тематических данных. Картографическая семиотика', page: 6 },
          { title: 'Тема 7. Картографический дизайн и его технология', page: 7 },
          { title: 'Тема 8. Геоинформационное картографирование — содержание и технология', page: 8 },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        topics: [
          ...
          { title: 'Тема 3. Психология личности', page: 3 },
          { title: 'Тема 4. Психологический анализ деятельности', page: 4 },
          { title: 'Тема 5. Проблема сознания в психологии. Сознание и неосознаваемые психические процессы', page: 5 },
          { title: 'Тема 6. Ощущение и восприятие как первый уровень системы психических процессов', page: 6 },
          { title: 'Тема 7. Внимание как психический процесс', page: 7 },
          { title: 'Тема 8. Память как ядро структуры психических процессов', page: 8 },
          { title: 'Тема 9. Мышление как высший уровень переработки информации. Системная организация мышления и речи. Психологические проблемы речевой деятельности', page: 9 },
          { title: 'Тема 10. Воображение', page: 10 },
          { title: 'Тема 11. Психология способностей', page: 11 },
          { title: 'Тема 12. Темперамент и характер', page: 12 },
          { title: 'Тема 13. Эмоционально-волевая сфера', page: 13 },
        ],
      },
      {
        key: 'psihologiya-razvitiya',
        ...
        topics: [
          ...
          { title: 'Тема 3. Закономерности психического развития', page: 3 },
          { title: 'Тема 4. Психология младенчества и раннего детства', page: 4 },
          { title: 'Тема 5. Психическое развитие в дошкольном возрасте', page: 5 },
          { title: 'Тема 6. Развитие ребенка в младшем школьном возрасте', page: 6 },
          { title: 'Тема 7. Психологические особенности подросткового возраста', page: 7 },
          { title: 'Тема 8. Психология ранней юности', page: 8 },
          { title: 'Тема 9. Психологические особенности ранней взрослости (от 20 до 40 лет)', page: 9 },
          { title: 'Тема 10. Психологическая характеристика зрелости и поздней зрелости', page: 10 },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        topics: [
          ...
          { title: 'Тема 3. Пределы и эквивалентности', page: 3 },
          { title: 'Тема 4. Производные', page: 4 },
          { title: 'Тема 5. Неопределённый и определённый интеграл', page: 5 },
          { title: 'Тема 6. ДУ с разделяющимися переменными и однородные', page: 6 },
          { title: 'Тема 7. Линейные ДУ первого порядка и уравнение Бернулли', page: 7 },
          { title: 'Тема 8. ДУ в полных дифференциалах и второго порядка', page: 8 },
          { title: 'Тема 9. Частные производные и дифференциал функции многих переменных', page: 9 },
          { title: 'Тема 10. Экстремум функции многих переменных; кратные интегралы', page: 10 },
        ],
      },
      {
        key: 'fizika',
        ...
        topics: [
          ...
          { title: 'Тема 3. Закон всемирного тяготения; космические скорости', page: 3 },
          { title: 'Тема 4. Элементы кеплеровых орбит', page: 4 },
          { title: 'Тема 5. Законы Кеплера; орбитальные интегралы', page: 5 },
          { title: 'Тема 6. Электростатика', page: 6 },
          { title: 'Тема 7. Проводники, диэлектрики, конденсаторы', page: 7 },
          { title: 'Тема 8. Постоянный электрический ток', page: 8 },
          { title: 'Тема 9. Магнитное поле; электромагнитная индукция', page: 9 },
          { title: 'Тема 10. Колебания, волны, квантовая физика', page: 10 },
        ],
      },
    ],
  },
...
const INTERACTIVE_TEST_CODES = ["7M01","7M02","7M03","7M04","7M05","7M06","7M07","7M08","7M11","7M12","M123","M066","M107","M005"]; // какие направления имеют интерактивный тест (не секрет — просто UI-подсказка, доступ проверяется на бэкенде)
...
const GOP_SUBJECTS = {
  ...
  M123: [
    ...COMMON_SUBJECTS,
    // Темы — из официальной спецификации теста «Геодезия-2» КТ (вступает в силу с 2026 г.).
    { id: 'p1', title: 'Геодезия', sub: 'измерения, съёмка и геодезические сети', kind: 'profile', topics: [
      'Определение положения точек земной поверхности. Системы координат и высот',
      'Ориентирование линий местности', 'Прямая и обратная геодезические задачи',
      'Топографические карты и планы. Масштабы. Уклон. Рельеф',
      'Геодезические измерения и их точность. Теория ошибок',
      'Угловые измерения', 'Линейные измерения', 'Измерение превышений',
      'Геодезические сети. Плановые и высотные сети сгущения',
      'Виды съёмок. Топографические съёмки',
      'Начальные сведения из инженерной геодезии', 'Современные геодезические приборы' ]},
    // Темы — из официальной спецификации теста «Картография» КТ (вступает в силу с 2026 г.).
    { id: 'p2', title: 'Картография', sub: 'проекции, генерализация и оформление карт', kind: 'profile', topics: [
      'Общие сведения о картографии. Элементы карты. Классификация карт',
      'Формы Земли, их параметры. Математическая основа карт',
      'Картографические проекции. Искажения на картах. Номенклатура',
      'Основные этапы создания карт',
      'Картографическая генерализация — типы и особенности',
      'Картографические способы изображения. Картографическая семиотика',
      'Картографический дизайн и его технология',
      'Геоинформационное картографирование — содержание и технология' ]},
  ],
  M066: [
    ...COMMON_SUBJECTS,
    // Темы — из официальной спецификации теста «Общая психология» КТ (вступает в силу с 2026 г.).
    { id: 'p1', title: 'Общая психология', sub: 'предмет, процессы и свойства психики', kind: 'profile', topics: [
      'Предмет, отрасли и задачи психологической науки и практики',
      'Методология и методы исследования психологии', 'Психология личности',
      'Психологический анализ деятельности',
      'Проблема сознания в психологии. Сознание и неосознаваемые психические процессы',
      'Ощущение и восприятие как первый уровень системы психических процессов',
      'Внимание как психический процесс', 'Память как ядро структуры психических процессов',
      'Мышление как высший уровень переработки информации. Мышление и речь',
      'Воображение', 'Психология способностей', 'Темперамент и характер',
      'Эмоционально-волевая сфера' ]},
    // Темы — из официальной спецификации теста «Психология развития» КТ (вступает в силу с 2026 г.).
    { id: 'p2', title: 'Психология развития', sub: 'возрастная динамика психики от рождения до старости', kind: 'profile', topics: [
      'Предмет, задачи и методы психологии развития', 'Теории психического развития',
      ...
      'Психологические особенности подросткового возраста', 'Психология ранней юности',
      'Психологические особенности ранней взрослости (от 20 до 40 лет)',
      'Психологическая характеристика зрелости и поздней зрелости' ]},
  ],
  M107: [
    ...COMMON_SUBJECTS,
    // Темы — из официальной спецификации теста «Физика» КТ (вступает в силу с 2025 г.).
    { id: 'p1', title: 'Физика', sub: 'механика, тяготение, электродинамика, колебания и волны, квантовая физика', kind: 'profile', topics: [
      'Физические основы механики', 'Тяготение', 'Электродинамика',
      'Физика колебаний и волн', 'Квантовая природа электромагнитного излучения' ]},
    // Темы — из официальной спецификации теста «Математика» КТ (вступает в силу с 2024 г.).
    { id: 'p2', title: 'Математика', sub: 'линейная алгебра, матанализ функций одной и многих переменных', kind: 'profile', topics: [
      'Линейная алгебра и аналитическая геометрия',
      'Дифференциальные и интегральные исчисления функции одной переменной',
      'Дифференциальные и интегральные исчисления функции многих переменных' ]},
  ],
  M005: [
    ...COMMON_SUBJECTS,
    { id: 'p1', title: 'Педагогика', sub: 'теория обучения и воспитания', kind: 'profile', topics: [
      'Дидактика: теория обучения', 'Теория и методика воспитания',
      'Современные педагогические технологии', 'История педагогики и образования' ]},
    { id: 'p2', title: 'Теория и методика физической культуры', sub: 'обучение двигательным действиям, физические качества, формы и методы физического воспитания', kind: 'profile', topics: [
      'Обучение двигательным действиям', 'Физические качества и их развитие',
      'Формы и методы физического воспитания', 'Физическое воспитание разных возрастных групп',
...
const GOP_DIRECTION_MAP = { M001: '7M01', M123: 'M123', M066: 'M066', M107: 'M107', M005: 'M005' };
...
function isPartialCreditSubject(code, section) {
  return (code === 'M123' || code === 'M066' || code === 'M107' || code === 'M005') && section === 'subj2';
}
...
// секции (subj1/subj2 — как в bySubject контента с бэкенда). Небольшое
...
function initScrollReveal() {
  ...
  const els = document.querySelectorAll(
    '.feat-card, .path-step, .about-us-text, .section-head, .contact-inner, .dir-card'
  );
