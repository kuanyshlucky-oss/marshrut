...
const GOP_SUBJECTS = {
  ...
  M103: [
    ...COMMON_SUBJECTS,
    { id: 'p1', title: 'Основы взаимозаменяемости', sub: 'допуски и посадки, отклонения формы, калибры, соединения', kind: 'profile', topics: [
      'Основные понятия: размеры, отклонения, допуски', 'Посадки и система допусков (ЕСДП)',
      'Отклонения формы и расположения. Шероховатость', 'Калибры и размерные цепи',
      'Резьбовые, шпоночные и шлицевые соединения', 'Зубчатые передачи и подшипники качения' ]},
    { id: 'p2', title: 'Детали машин', sub: 'соединения, передачи, валы и подшипники, материалы', kind: 'profile', topics: [
      'Основы проектирования и критерии работоспособности', 'Материалы и допускаемые напряжения',
      'Соединения деталей машин', 'Механические передачи', 'Валы, оси и подшипники' ]},
  ],
};
