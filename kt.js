...
const KT_LOGIC_POOL = [
  ...
  {"q":"Если площадь прямоугольника ABCD будет равна 70, то найдите площадь квадрата EFGH.","options":["249","281","209","156","176"],"correct":1,"explanations":["неверное значение --- не получается при правильном решении уравнения.","Верно! Площадь ABCD = (x+3)(x+2) = 70 ⟹ x²+5x−64=0. Сторона квадрата = 2x+5 = √281 (числа подобраны так, что 2x+5 при решении уравнения даёт ровно √281), значит площадь квадрата = (√281)² = 281.","неверное значение --- не соответствует решению.","неверное значение --- не соответствует решению.","неверное значение --- не соответствует решению."]},
  {"q":"Сравните величины A и B. A = 0,3⁵/0,3³. B: 0,1x − 0,001 = 0,01, найдите x.","options":["Недостаточно информации для сравнения","Величины равны","Величина B больше","Величина A больше"],"correct":2,"explanations":["неверно --- обе величины вычисляются однозначно, сравнить можно.","неверно --- A=0,09, а B=0,11, значения разные.","Верно! A = 0,3⁵∕0,3³ = 0,3² = 0,09. B: 0,1x=0,011 ⟹ x=0,11. Так как 0,11 > 0,09, величина B больше.","неверно --- всё наоборот, B больше, а не A."]},
  {"q":"Если f(x) = ax² − x и f(3) = 6, то определите значение f(−2).","options":["-2","-8","1","4","6"],"correct":4,"explanations":["неверно --- результат ошибки при подстановке.","неверно --- результат ошибки при нахождении a или подстановке.","неверно --- не соответствует правильному вычислению.","неверно --- не соответствует правильному вычислению.","Верно! Из f(3)=6: 9a−3=6 ⟹ a=1, то есть f(x)=x²−x. Тогда f(−2) = (−2)² − (−2) = 4+2 = 6."]},
  {"q":"Промежуток, показывающий решение неравенства x² + 4 < 0","options":["x∈∅","x∈(−2;2)","x∈(−∞;−2)∪(−2;2)∪(2;+∞)","x∈(−∞;−2)∪(2;+∞)","x∈(−∞;+∞)"],"correct":0,"explanations":["Верно! x² всегда ≥ 0 для любого x, значит x²+4 ≥ 4 > 0 всегда. Неравенство x²+4<0 не выполняется никогда, решений нет.","это было бы решением другого неравенства (например, x²−4<0), а не x²+4<0.","не относится к данному неравенству, здесь перепутаны знаки.","не относится к данному неравенству.","это было бы решением неравенства x²+4>0 (верного всегда), а не «<0»."]},
  {"q":"Произведение 5² · 9² · 3³ заканчивается цифрой","options":["3","2","5","1","0"],"correct":2,"explanations":["неверно --- не совпадает с последней цифрой произведения.","неверно --- не совпадает.","Верно! 5²·9²·3³ = 25×81×27. 25×81=2025 (оканчивается на 5), 2025×27=54675 --- оканчивается на 5.","неверно --- не совпадает.","неверно --- произведение не кратно 10, так как среди множителей нет числа, дающего в конце 0."]},
  {"q":"Если a=1, b=1, то вычислите значение выражения (√3a⁻²b − √27ab⁻²) / √3a⁻²b⁻²","options":["1","-2","9","-1","-9"],"correct":1,"explanations":["неверно --- не соответствует вычислению.","Верно! При a=1,b=1: числитель = √3 − √27 = √3 − 3√3 = −2√3; знаменатель = √3. Итог: −2√3 / √3 = −2.","неверно --- не соответствует вычислению.","неверно --- похоже на потерю множителя 2 в ответе.","неверно --- не соответствует вычислению."]},
  {"q":"Сравните A и B. A: решите уравнение (x−7)(x+7)+49=0. B: 7³ − 343 =","options":["Величина B больше","Недостаточно информации для сравнения","Величина A больше","Величины равны"],"correct":3,"explanations":["неверно --- обе величины равны 0.","неверно --- обе величины вычисляются точно.","неверно --- обе величины равны 0.","Верно! A: (x−7)(x+7)+49=0 ⟹ x²−49+49=0 ⟹ x²=0 ⟹ x=0. B: 7³−343 = 343−343 = 0. Обе величины равны 0."]},
  {"q":"Решите неравенство |2x−1| > 1 и укажите верный промежуток для переменной x","options":["x∈(−∞;+∞)","x∈(−∞;0)∪(1;+∞)","x∈∅","x∈(0;1)","x∈(−1;+∞)"],"correct":1,"explanations":["неверно --- неравенство выполняется не для всех x (например, x=0,5 не подходит).","Верно! |2x−1|>1 ⟹ 2x−1>1 или 2x−1<−1 ⟹ x>1 или x<0, то есть x∈(−∞;0)∪(1;+∞).","неверно --- решения существуют.","неверно --- это как раз промежуток, где неравенство НЕ выполняется.","неверно --- не соответствует решению."]},
  {"q":"Опрос 150 учащихся: 68 --- алгебра, 68 --- химия, 80 --- физика; 28 алгебра и химия, 35 алгебра и физика, 30 физика и химия, 20 --- все три предмета. Сколько не выбрали или им не нравится ни один из предметов?","options":["7","4","5","6","8"],"correct":0,"explanations":["Верно! По формуле включений-исключений: |A∪Х∪Ф| = 68+68+80−28−35−30+20 = 143. Не выбрали ни один предмет: 150−143 = 7.","неверно --- не соответствует расчёту по формуле включений-исключений.","неверно --- не соответствует расчёту.","неверно --- не соответствует расчёту.","неверно --- не соответствует расчёту."]},
  {"q":"Таблица зарплат: 5 работников×100000, 4×112000, 8×118000, 3×125000. Вычислите среднюю заработную плату.","options":["117 650","115 150","114 850","119 900","113 350"],"correct":4,"explanations":["неверно --- не соответствует расчёту средневзвешенного значения.","неверно --- не соответствует расчёту.","неверно --- не соответствует расчёту.","неверно --- не соответствует расчёту.","Верно! Сумма = 5×100000+4×112000+8×118000+3×125000 = 500000+448000+944000+375000 = 2 267 000. Количество работников = 20. Средняя = 2 267 000 / 20 = 113 350."]},
  {"q":"Найдите угол x°. Треугольник с углами (y°+x°), (70°−y°) и 85°.","options":["30°","10°","45°","25°","20°"],"correct":3,"explanations":["неверно --- не соответствует расчёту суммы углов треугольника.","неверно --- не соответствует расчёту.","неверно --- не соответствует расчёту.","Верно! Сумма углов треугольника = 180°: (y+x)+(70−y)+85=180 ⟹ x+155=180 ⟹ x=25°. Слагаемые y взаимно уничтожаются.","неверно --- не соответствует расчёту."]},
  {"q":"Сравните A и B. A: сумма чисел 7,8,16,19 равна сумме чисел 3,4,x и x+3 --- найдите x. B: наибольшее простое число между 10 и 20.","options":["Величина A больше","Недостаточно информации для сравнения","Величины равны","Величина B больше"],"correct":0,"explanations":["Верно! A: 7+8+16+19=50; 3+4+x+(x+3)=50 ⟹ 2x+10=50 ⟹ x=20. B: наибольшее простое число между 10 и 20 --- это 19. Так как 20>19, величина A больше.","неверно --- обе величины вычисляются однозначно.","неверно --- 20 ≠ 19, величины не равны.","неверно --- 19<20, величина B меньше, а не больше."]},
  {"q":"Если |5x−4| > 2 и x < 1, то x примет одно из следующих значений","options":["-0,6","0,6","1","0,5","1,3"],"correct":0,"explanations":["⚠ ТРЕБУЕТ ПРОВЕРКИ: по результатам реального тестирования этот ответ был отмечен как неверный, хотя по расчёту |5x−4|>2 ⟹ x>1,2 или x<0,4; с учётом x<1 остаётся x<0,4, чему удовлетворяет только −0,6. Возможно, в оригинале условие записано иначе (другой знак неравенства или «x>1» вместо «x<1») --- пересверьте точную формулировку по скриншоту задания.","при исходной записи неверно --- 0,6 не входит ни в x<0,4, ни в x>1,2. Но если условие было бы |5x−4|<2 (а не «>»), то решение 0,4<x<1,2 и 0,6 стало бы верным ответом --- стоит перепроверить исходный знак неравенства.","неверно --- x=1 не удовлетворяет условию x<1 (не строго меньше) и не входит в решение неравенства.","неверно --- 0,5 не входит ни в один из промежутков решения.","при исходной записи неверно --- 1,3>1,2 удовлетворяло бы неравенству, но противоречит условию x<1. Однако если условие было «x>1» (а не «x<1»), то верным ответом стало бы именно 1,3 --- стоит перепроверить исходную формулировку."]},
  {"q":"Если d>a и P<a, то одно из следующих выражений будет неверно","options":["d−P=3","P−a=5","P−a=−5","P−d=−12","P+d=12"],"correct":1,"explanations":["может быть верным --- так как d>a>P, разность d−P положительна, значение 3 не противоречит условию.","Верно, это НЕВЕРНОЕ выражение! Так как P<a, разность P−a обязательно отрицательна. Значение +5 (положительное) противоречит этому условию.","может быть верным --- P−a=−5 (отрицательное значение) полностью соответствует условию P<a.","может быть верным --- так как d>P, разность P−d отрицательна, значение −12 не противоречит условию.","может быть верным --- сумма P+d не ограничена условиями задачи, значение 12 не противоречит ничему."]},
...
function beginKT(code, typeId, lang) {
  ...
  a.blocks.forEach(b => b.questions.forEach(q => flat.push({
    q: q.q, options: q.options, correct: q.correct, why: q.why, explanations: q.explanations, block: b.id,
