...
const INTERACTIVE_TEST_CODES = ["7M01","7M02","7M03","7M04","7M05","7M06","7M07","7M08","7M11","7M12","M123","M066","M107","M005","M103"]; // какие направления имеют интерактивный тест (не секрет — просто UI-подсказка, доступ проверяется на бэкенде)
...
const GOP_DIRECTION_MAP = { M001: '7M01', M123: 'M123', M066: 'M066', M107: 'M107', M005: 'M005', M103: 'M103' };
...
// машин (M103, subj2) — предметы с частичным начислением баллов по официальной схеме
...
function isPartialCreditSubject(code, section) {
  return (code === 'M123' || code === 'M066' || code === 'M107' || code === 'M005' || code === 'M103') && section === 'subj2';
}
