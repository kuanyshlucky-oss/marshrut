...
// Картография (M123, subj2) и Психология развития (M066, subj2) — предметы с
// частичным начислением баллов по официальной схеме КТ для вопросов с
// множественным выбором (до 3 верных ответов): 2 балла — все верные выбраны и
// ни одного лишнего; 1 балл — ровно одна ошибка (не выбран один верный, ИЛИ
// выбраны все верные плюс один лишний); 0 баллов — две и более ошибки, включая
// пустой ответ. Остальные предметы (включая другие вопросы с несколькими
// ответами) считаются «всё или ничего» за 1 балл.
function isPartialCreditSubject(code, section) { return (code === 'M123' || code === 'M066') && section === 'subj2'; }
