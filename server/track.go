...
func seedTrack() error {
	...
	_, err := db.Exec(`INSERT INTO checklist_templates(year, step_order, description, deadline) VALUES
		...
		(2026, 9, 'Зимний период: зарегистрироваться на КТ на сайте Национального центра тестирования', '2026-11-10'),
		(2026, 10, 'Зимний период: сдать КТ (иностранный язык + профильный предмет)', '2026-12-11')
