...
const INTERACTIVE_TEST_CODES = ["7M01","7M02","7M03","7M04","7M05","7M06","7M07","7M08","7M11","7M12","M123","M066","M107"]; // какие направления имеют интерактивный тест (не секрет — просто UI-подсказка, доступ проверяется на бэкенде)
...
const GOP_SUBJECTS = {
  ...
  M107: [
    ...
    { id: 'p1', title: 'Математика', sub: 'линейная алгебра, матанализ функций одной и многих переменных', kind: 'profile', topics: [
    ...
    { id: 'p2', title: 'Физика', sub: 'механика, тяготение, электродинамика, колебания и волны, квантовая физика', kind: 'profile', topics: [
...
const GOP_DIRECTION_MAP = { M001: '7M01', M123: 'M123', M066: 'M066', M107: 'M107' };
...
// (M107, subj1) — предметы с частичным начислением баллов по официальной схеме
...
function isPartialCreditSubject(code, section) {
  return (code === 'M123' || code === 'M066') && section === 'subj2' || code === 'M107' && section === 'subj1';
}
