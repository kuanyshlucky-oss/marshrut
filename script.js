...
'7M01': { title: 'Профильный тест: педагогика и психология',
    questions: [
      ...
      {"q":"Ключевое слово в эксперименте П. П. Блонского по исследованию мышления и интеллектуальных процессов","options":["единица","лес","зонтик","кисточка","палочка","мышь","ложка","ветер"],"correct":2,"explanations":["неверно --- не относится к классическому эксперименту Блонского.","неверно --- не относится к данному эксперименту.","⚠ ТРЕБУЕТ ПРОВЕРКИ: по результатам реального тестирования этот ответ отмечен как неверный. Точное ключевое слово эксперимента Блонского нужно перепроверить по первоисточнику (учебник Гиппенрейтер / Немов, раздел о мышлении) --- возможно, это «палочка», «ложка» или «кисточка» (предметные экспериментальные задачи на понимание и обобщение).","неверно (согласно предыдущей версии ответа) --- но требует перепроверки, см. пометку у варианта C.","неверно (согласно предыдущей версии ответа) --- но требует перепроверки, см. пометку у варианта C.","неверно --- не относится к данному эксперименту.","неверно (согласно предыдущей версии ответа) --- но требует перепроверки, см. пометку у варианта C.","неверно --- не относится к данному эксперименту."]},
