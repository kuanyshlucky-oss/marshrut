    ...
    sections: [
      {
        ...
        topics: [
          ...
          { title: 'Тема 2. Системы линейных алгебраических уравнений', page: 2 },
          { title: 'Тема 3. Векторная алгебра', page: 3 },
          { title: 'Тема 4. Аналитическая геометрия на плоскости и в пространстве', page: 4 },
          { title: 'Тема 5. Предел и непрерывность функции', page: 5 },
          { title: 'Тема 6. Производная функции и её приложения', page: 6 },
          { title: 'Тема 7. Исследование функции и построение графика', page: 7 },
          { title: 'Тема 8. Неопределённый интеграл', page: 8 },
          { title: 'Тема 9. Определённый интеграл и его приложения', page: 9 },
          { title: 'Тема 10. Частные производные и дифференциал функции многих переменных', page: 10 },
          { title: 'Тема 11. Экстремум функции нескольких переменных', page: 11 },
          { title: 'Тема 12. Двойные и тройные интегралы', page: 12 },
        ],
      },
      {
        key: 'fizika',
        ...
        pages: 18,
        topics: [
          { title: 'Тема 1. Кинематика материальной точки', page: 1 },
          { title: 'Тема 2. Кинематика твёрдого тела', page: 2 },
          { title: 'Тема 3. Динамика материальной точки. Законы Ньютона', page: 3 },
          { title: 'Тема 4. Неинерциальные системы отсчёта. Силы инерции', page: 4 },
          { title: 'Тема 5. Динамика системы материальных точек. Моменты силы и импульса', page: 5 },
          { title: 'Тема 6. Вращение твёрдого тела вокруг неподвижной оси', page: 6 },
          { title: 'Тема 7. Работа, мощность и энергия', page: 7 },
          { title: 'Тема 8. Законы сохранения в механике', page: 8 },
          { title: 'Тема 9. Закон всемирного тяготения. Космические скорости', page: 9 },
          { title: 'Тема 10. Электростатическое поле. Теорема Гаусса', page: 10 },
          { title: 'Тема 11. Проводники и диэлектрики в электростатическом поле', page: 11 },
          { title: 'Тема 12. Постоянный электрический ток', page: 12 },
          { title: 'Тема 13. Магнитное поле. Закон Био — Савара — Лапласа', page: 13 },
          { title: 'Тема 14. Электромагнитная индукция. Уравнения Максвелла', page: 14 },
          { title: 'Тема 15. Механические и электромагнитные колебания', page: 15 },
          { title: 'Тема 16. Волны. Интерференция и дифракция света', page: 16 },
          { title: 'Тема 17. Поляризация света', page: 17 },
          { title: 'Тема 18. Тепловое излучение и фотоэффект', page: 18 },
        ],
      },
    ],
  },
